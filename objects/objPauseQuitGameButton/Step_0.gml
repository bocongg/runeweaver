...
if (device_mouse_x_to_gui(0) > bbox_left && device_mouse_x_to_gui(0) < bbox_right && device_mouse_y_to_gui(0) > bbox_top && device_mouse_y_to_gui(0) < bbox_bottom)
{
	...
	if (is_clicked)
	{
		...
		{
			instance_destroy(objReturnToGameButton);
			instance_destroy(objPauseQuitGameButton);
			instance_destroy(objPauseScreen1);
			instance_create_layer(1920/2, 1080/2, "PauseScreen", objPauseScreen2);
		}
	}
} else {
	sprite_index = sprPauseButtons;
