draw_self();
var nodeSpr = object_get_sprite(objRmNode5);
var roomID = object_get_name(objRmNode5);
...
} else if (global.stage == 2 && ds_list_find_index(global.stagesCleared, "objRmNode2") == -1){
	draw_sprite(nodeSpr, 3, x, y);
	if (mouse_check_button_pressed(mb_left)) {
		// Sets click state to false.
		is_clicked = false;
